...
const ClosedPositionRow = memo(function ClosedPositionRow({
  ...
  const flowFromTicker = isBuy ? quoteTicker : baseTicker;
  const flowToTicker = isBuy ? baseTicker : quoteTicker;
        ...
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center flex-1">
            ...
            <View className="flex-row items-center ml-2.5">
              ...
              <Ionicons name="arrow-forward" size={14} color={uiColors.textMuted} style={{ marginHorizontal: 4 }} />
              <Text className="text-sm leading-5" style={{ color: uiColors.textMuted }}>
                {flowToTicker}
              </Text>
            </View>
        ...
        <View className="mt-3 pt-3 border-t" style={{ borderTopColor: uiColors.divider }}>
          ...
          {!expanded && (
            <View className={`flex-row items-center justify-between ${showChartSection ? 'mt-3' : ''}`}>
              ...
              <Ionicons name="arrow-forward" size={11} color={uiColors.textSubtle} />
              <Text
                className="text-[14px] font-semibold leading-5"
                style={[{ color: uiColors.textSecondary }, TABULAR_NUMS]}
              >
